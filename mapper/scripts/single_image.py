...
def run(test_opts):
    ...
    latent_codes_origin = np.reshape(np.load('/media/aj/9c4728aa-3a45-44cf-ada0-079baa4684ac/home/webtunix/hairai/HairCLIP-main/encoder4editing/results/8d61fbc8-acd3-4bc4-a5a5-79e992e2d5fc_01.npy'), (1, 18, 512))
    ...
    for input_batch in tqdm(dataloader):
        ...
        with torch.no_grad():
            ...
            for i in range(len(selected_description_tuple_list)):
                ...
                # torchvision.utils.save_image(result_batch[0][0].unsqueeze(0), os.path.join(out_path_results,
                #                                                                            f"{im_path}-{str(i).zfill(4)}-{selected_description}.jpg"),
