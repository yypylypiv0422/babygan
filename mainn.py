...
from s33_uploaddd import uploadding
...
#
    ...
    for i in range(2):
        ...
        if i == 0:
            ...
            age_list=[2,5,8,11.14]
            bbb=age_list.index(agee)
            hh = [-140, -80, -49, -44, -36]
            # hh = [-140,-80, -49, -44, -36]
...
#                                   age=-60, genes_influence=0.85))
    ...
    directoriess = ["./aligned_images", "./latent_representations", "./generated_images","./raw_images"]
    for dd in directoriess:
        files = glob.glob(dd+'/*')
        for f in files:
            os.remove(f)

    final_urls=uploadding(output_folder)
...
# outt='/media/aj/9c4728aa-3a45-44cf-ada0-079baa4684ac/home/webtunix/new_babygan/final_output'
# age=2
# main_functionn(father_input_image,mother_input_image,outt,age)
